...
/**
 * Spike lockstep cosim checker for the riscv-dv Verilator TB.
 *
 * Adapted from dv/verilator/simple_system_cosim/ibex_simple_system_cosim_checker.sv
 * with UVM-matching start_pc / start_mtvec (0x80000080 / 0x80000001).
 */
module ibex_riscv_dv_cosim_checker #(
  ...
  always @(posedge clk_i) begin
    if (u_top.rvfi_valid) begin
      ...
      if (riscv_cosim_step(cosim_handle, u_top.rvfi_rd_addr, u_top.rvfi_rd_wdata,
                           ...
                           u_top.rvfi_ext_rf_wr_suppress) == 0) begin
